  ...
  return <div className="shell noise">
    ...
    <main className="mx-auto max-w-[1240px] px-6 py-12">
      <div className="mb-8 flex items-end justify-between gap-6">
        ...
        <div className="hidden items-center gap-2 text-xs font-medium text-[#7a857d] md:flex"><span className="size-2 rounded-full bg-[#20b869] shadow-[0_0_0_4px_#dff7e8]"/> No ripgrep, jq, or Bash required</div>
      </div>
